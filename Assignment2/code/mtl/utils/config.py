...
def command_line_parser(args=None):
    ...
    parser.add_argument(
        '--model_name', type=str, default='deeplabv3p', choices=['deeplabv3p', 'deeplab_branched', 'deeplab_distilled', 'deeplab_branched_se', 'deeplab_distilled_se'], help='CNN architecture')
    parser.add_argument(
        '--model_encoder_name', type=str, default='resnet34', choices=['resnet34','resnet50'], help='CNN architecture encoder')
