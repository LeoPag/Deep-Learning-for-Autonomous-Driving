...
from mtl.models.model_parts import Encoder, get_encoder_channel_counts, ASPP, DecoderDeeplabV3p, DecoderDeeplabV3p_noskip, SelfAttention


class ModelDeepLabDistilled(torch.nn.Module):
